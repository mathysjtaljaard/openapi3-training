...
public class ApiClient {
    ...
    private String basePath = "https://api.server.test/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("JwtAuthToken", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.server.test/v1
